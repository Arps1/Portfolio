        ...
        <div class="container mx-auto">
            ...
            @if(auth()->user()->role === 'admin')
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    ...
                    <p class="mb-6">Selamat datang, Admin! Di sini Anda bisa mengelola portofolio, menambahkan karya, dan mengelola pengaturan lainnya.</p>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="bg-green-200 p-4 rounded-lg shadow-lg">
                            ...
                            <p class="text-gray-700">Saya terbuka untuk peluang kerja sama, kolaborasi proyek, maupun freelance. Jangan ragu untuk menghubungi saya jika Anda tertarik bekerja sama dalam bidang teknologi, pemrograman, atau pengembangan aplikasi.</p>
                            <a href="{{ route('kontak') }}" class="text-green-600">Hubungi Saya</a>
                        </div>
                        <div class="bg-yellow-200 p-4 rounded-lg shadow-lg">
                            ...
                            <a href="{{ route('tentang') }}" class="text-yellow-600">Lihat Pengguna</a>
                        </div>
                    </div>
                </div>
            @else
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    ...
                    <p class="mb-6">Selamat datang! Di sini Anda dapat melihat portofolio saya, menghubungi saya, dan mempelajari lebih lanjut tentang konsep yang saya tawarkan.</p>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-green-200 p-4 rounded-lg shadow-lg">
                            ...
                            <p class="text-gray-700">Pelajari lebih lanjut tentang saya dan pengalaman saya.</p>
